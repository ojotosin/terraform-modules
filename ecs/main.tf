...
resource "aws_ecs_cluster" "ecs_cluster" {
  ...
  setting {
    ...
    value = "disabled"   // i'm disabling for the sake of the project to save cost
  }
}
...
resource "aws_ecs_service" "ecs_service" {
  ...
  network_configuration {
    subnets          = [var.private_app_subnet_az1_id, var.private_app_subnet_az2_id]   //subnets to create the containers in 
